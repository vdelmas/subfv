...
set key top left
set pointsize 0.5
plot 'outputs/two_wave/line_export.csv' using 19:22 w lp lw 2 title 'Two Wave', 'outputs/three_wave/line_export.csv' using 19:22 w lp lw 2 title 'Three Wave', 'outputs/modified_three_wave/line_export.csv' using 19:22 w lp lw 2 title 'Modified Three Wave', 'outputs/multi_point/line_export.csv' using 19:22 w lp lw 2 title 'Multi Point', 'outputs/multi_point_iso/line_export.csv' using 19:22 w lp lw 2 title 'Multi Point Iso', 'outputs/ZB_AR1D_LS/line_export.csv' using 19:22 w lp lw 2 title 'ZB AR1D LS', 'outputs/ZB_AR1D_LSM/line_export.csv' using 19:22 w lp lw 2 title 'ZB AR1D LSM', 'outputs/ZB_ARMD_LS/line_export.csv' using 19:22 w lp lw 2 title 'ZB ARMD LS', 'outputs/ZB_ARMD_LSM/line_export.csv' using 19:22 w lp lw 2 title 'ZB ARMD LSM', 'outputs/ZB_ARMDM_LS/line_export.csv' using 19:22 w lp lw 2 title 'ZB ARMDM LS', 'outputs/ZB_ARMDM_LSM/line_export.csv' using 19:22 w lp lw 2 title 'ZB ARMDM LSM', 'outputs/ZB_ARMDMAT_LS/line_export.csv' using 19:22 w lp lw 2 title 'ZB ARMDMAT LS', 'outputs/ZB_ARMDMAT_LSM/line_export.csv' using 19:22 w lp lw 2 title 'ZB ARMDMAT LSM', 'outputs/ZB_ARMDMMAT_LS/line_export.csv' using 19:22 w lp lw 2 title 'ZB ARMDMMAT LS', 'outputs/ZB_ARMDMMAT_LSM/line_export.csv' using 19:22 w lp lw 2 title 'ZB ARMDMMAT LSM', 'outputs/ZB_AM_LS/line_export.csv' using 19:22 w lp lw 2 title 'ZB AM LS', 'outputs/ZB_AM_LSM/line_export.csv' using 19:22 w lp lw 2 title 'ZB AM LSM', 'outputs/ZB_AMISO_LS/line_export.csv' using 19:22 w lp lw 2 title 'ZB AMISO LS', 'outputs/ZB_AMISO_LSM/line_export.csv' using 19:22 w lp lw 2 title 'ZB AMISO LSM'
