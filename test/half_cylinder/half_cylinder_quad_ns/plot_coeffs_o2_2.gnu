...
set pointsize 0.5
plot 'outputs/two_wave_o2_2/coeffs_export.csv' using 7:8 smooth unique w lp lw 2 title 'Two Wave', 'outputs/three_wave_o2_2/coeffs_export.csv' using 7:8 smooth unique w lp lw 2 title 'Three Wave', 'outputs/modified_three_wave_o2_2/coeffs_export.csv' using 7:8 smooth unique w lp lw 2 title 'Modified Three Wave', 'outputs/multi_point_o2_2/coeffs_export.csv' using 7:8 smooth unique w lp lw 2 title 'Multi Point', 'outputs/multi_point_iso_o2_2/coeffs_export.csv' using 7:8 smooth unique w lp lw 2 title 'Multi Point Iso', 'outputs/sidil_o2_2/coeffs_export.csv' using 7:8 smooth unique w lp lw 2 title 'Sidil'
