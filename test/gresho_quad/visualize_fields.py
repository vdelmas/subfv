...
save_field("Velocity", True,  "images/gresho_quad_velocity.png")
save_field("Density",  False, "images/gresho_quad_density.png")
save_field("Pressure", False, "images/gresho_quad_pressure.png")
